...
class SendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sender" do
    assert_difference('Sender.count') do
      post senders_url, params: { sender: { address: @sender.address, email: @sender.email, latitude: @sender.latitude, longitude: @sender.longitude, name: @sender.name, status: @sender.status, telephone: @sender.telephone } }
    end
  ...
  test "should update sender" do
    patch sender_url(@sender), params: { sender: { address: @sender.address, email: @sender.email, latitude: @sender.latitude, longitude: @sender.longitude, name: @sender.name, status: @sender.status, telephone: @sender.telephone } }
